...
public interface RestSpreadsheets {
	...
	String createSpreadsheet(@HeaderParam ("version") long version, Spreadsheet sheet, @QueryParam("password") String password, @HeaderParam ("first") int first);
	...
	@DELETE
	@Path("/{sheetId}")
	void deleteSpreadsheet(@HeaderParam ("version") long version, @PathParam("sheetId") String sheetId, @QueryParam("password") String password, @HeaderParam ("first") int first);
	...
	@Path("/{sheetId}")
	@Produces(MediaType.APPLICATION_JSON)
	Spreadsheet getSpreadsheet(@HeaderParam ("version") long version, @PathParam("sheetId") String sheetId , @QueryParam("userId") String userId, 
			@QueryParam("password") String password, @HeaderParam ("first") int first);
	...
	@Path("/{sheetId}/values")
	@Produces(MediaType.APPLICATION_JSON)
	String[][] getSpreadsheetValues(@HeaderParam ("version") long version, @PathParam("sheetId") String sheetId, 
			@QueryParam("userId") String userId, @QueryParam("password") String password, @HeaderParam ("first") int first);
	...
	@Path("/{sheetId}/{cell}")
	@Consumes(MediaType.APPLICATION_JSON)
	void updateCell( @HeaderParam ("version") long version, @PathParam("sheetId") String sheetId, @PathParam("cell") String cell, String rawValue, 
			@QueryParam("userId") String userId, @QueryParam("password") String password, @HeaderParam ("first") int first);
	...
	void shareSpreadsheet(@HeaderParam ("version") long version, @PathParam("sheetId") String sheetId, @PathParam("userId") String userId, 
			@QueryParam("password") String password, @HeaderParam ("first") int first);
	...
	@DELETE
	@Path("/{sheetId}/share/{userId}")
	void unshareSpreadsheet( @HeaderParam ("version") long version, @PathParam("sheetId") String sheetId, @PathParam("userId") String userId, 
			@QueryParam("password") String password, @HeaderParam ("first") int first);
	...
	@Path("/{userId}/sheets")
	@Consumes(MediaType.APPLICATION_JSON)
	void deleteSpreadsheets(@HeaderParam ("version") long version, @PathParam("userId") String userId, @HeaderParam ("first") int first);

	
	@GET
	@Path("/{sheetId}/fetch")
	@Produces(MediaType.APPLICATION_JSON)
	String[][] fetchSpreadsheetValues(@HeaderParam ("version") long version, @PathParam("sheetId") String sheetId, @QueryParam("userId") String userId, @HeaderParam("secret") String secret, @HeaderParam ("first") int first);
}
