...
public interface RestSpreadsheets {
	 ...
	 */
	@DELETE
	@Path("/{userId}/delsheet")
	void deleteSheetsFromUser( @PathParam("userId") String userId);
	 ...
	 */
	@GET
	@Path("/{sheetId}/sheetImport")
	@Produces(MediaType.APPLICATION_JSON)
	String[][] getSpreadImport(@PathParam("sheetId") String sheetId);
